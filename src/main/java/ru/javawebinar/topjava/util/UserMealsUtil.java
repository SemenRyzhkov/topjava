...
public class UserMealsUtil {
        ...
        for (UserMeal meal : meals) {
            ...
            if (TimeUtil.isBetweenHalfOpen(meal.getDateTime().toLocalTime(), startTime, endTime)) {
                userMealWithExcesses.add(new UserMealWithExcess(
                        ...
                        meal.getDescription(),
                        meal.getCalories(),
                        allCaloriesPerDay.get(localDate) > caloriesPerDay
                ));
            }
        }
    ...
    public static List<UserMealWithExcess> filteredByStreams(
        ...
        Map<LocalDate, Integer> allCaloriesPerDay = meals
                .stream()
        ...
        return meals
                ...
                .map(um -> new UserMealWithExcess(um.getDateTime(),
                        um.getDescription(),
                        um.getCalories(),
                        allCaloriesPerDay.get(um.getDateTime().toLocalDate()) > caloriesPerDay))
