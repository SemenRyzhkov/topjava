...
<div class="container">
    <p class="h2 mt-3 mb-3 text-center"><spring:message code="meal.title"/></p>
    ...
    <form method="get" action="meals/filter">
        ...
        <button class="btn btn-primary" onclick="add()"><spring:message code="meal.filter"/></button>
    </form>
    <hr>
    ...
    <hr>
    <table class="table table-bordered table-hover" id="mealTable">
        <thead>
        <tr>
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr id="${meal.id}" data-mealExcess="${meal.excess}">
                ...
                <td><a class="delete fa"><spring:message code="common.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="save(mtx)">
