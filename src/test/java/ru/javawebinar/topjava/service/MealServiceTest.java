...
public class MealServiceTest extends TestCase {
    ...
    public void getBetweenInclusive() {
        List<Meal> meals = service.getBetweenInclusive(
                LocalDate.of(2021, Month.JANUARY, 22),
    ...
    public void update() {
        ...
        assertMatch(service.get(USER_ID, USER_ID), getUpdated());
    }
    ...
    public void duplicateMailCreate() {
        assertThrows(DataAccessException.class, () ->
                service.create(new Meal(
                        null,
                        LocalDateTime.of(2021, Month.JANUARY, 22, 13, 21), "new meal", 1350),
                        USER_ID));
    }
}